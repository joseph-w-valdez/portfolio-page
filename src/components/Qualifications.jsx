    ...
    <div className='section qualifications-section'>
        ...
        <div className='qualifications'>
            <a className="qualification-link" href='https://learningfuze.com/' target='_blank' rel="noopener noreferrer">
                <div className="qualification" >
                    <div className="title-logo-container">
                        <img src="https://media.licdn.com/dms/image/C560BAQEimxlasi9TvQ/company-logo_100_100/0/1592771574713?e=1689206400&v=beta&t=9FPoN7kXbnv-CaYANa2HKE-P0x4O7H_Ay3dEaH7zm5A" alt="LearningFuze" />
                        <div>
            ...
            <a className="qualification-link" href='https://www.linkedin.com/in/joseph-w-valdez/details/recommendations/' target='_blank' rel="noopener noreferrer">
                <div className="qualification" >
                    <div className="title-logo-container">
                        <img src="https://media.licdn.com/dms/image/C4E03AQFCVpKOnAeOUA/profile-displayphoto-shrink_100_100/0/1516167350883?e=1686182400&v=beta&t=UQ0WoZHbV5LnN9u75ChkqLs9oJ82V1PHOUQONGlNLZU" alt="Robert Gardner" />
                        <div>
